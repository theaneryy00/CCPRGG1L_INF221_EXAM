...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.print("the total character of my firstname and surname is " + length);
        ...
        System.out.println("\n 4. Check your first name in LOWERCASE and UPPERCASE");
        ...
        if (firstNameInLowerCase.toLowerCase().equals("thea") == firstNameInUpperCase.toUpperCase().equals("THEA")) {
        ...
        if (firstName == firstNameInUpperCase || surName == surName.toLowerCase()){
        ...
        if (studentEmailAddress.contains("nery")){
            System.out.println("VALID");
    ...
    static void firstNameInLowerCase (){
        System.out.println("\n 4. Check your first name in LOWERCASE and UPPERCASE");
        System.out.print("Enter your first name in lowercase: ");
        String firstNameInLowerCase = scan.next();
        System.out.print("Enter your first name in UPPERCASE: ");
